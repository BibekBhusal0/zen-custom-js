...
| `extension.browse-bot.findbar-ai.remember-dimensions`      | Boolean | `false`                        | Remembers the size of the findbar window across sessions.                                                   |
...
| `extension.browse-bot.findbar-ai.background-style`         | String  | `"acrylic"`                    | The background style of the findbar. Options: `solid`, `acrylic`, `pseudo`.                                 |
